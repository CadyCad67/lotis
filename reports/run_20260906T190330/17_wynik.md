...
**Status:** degraded · **run:** `20260906T190330` · **snapshot:** `sha256:f3c290f4e6930407` · **0.09 ms**

Rejs LO3981: prognoza 62991.94 PLN, rzeczywistosc 32960.55 PLN, blad -47.7%. Klasyfikacja: BLAD_MODELU. Wynik POZA widelkami prognozy.
...
| `strata_prognozowana` | 62991.94 PLN | PLN |
| `strata_rzeczywista` | 32960.55 PLN | PLN |
| `blad` | -30031.39 PLN | PLN |
| `blad_procentowo` | -47.67 | % |
| `w_widelkach` | 0 | - |
| `rodzaj_bledu` | BLAD_MODELU | - |

## Co ten node ustalil

- wycena rozminela sie o -47.7% przy poprawnym wykonaniu i przyjetej rekomendacji
...
- **klasyfikacja**
  - **rodzaj:** BLAD_MODELU
  - **opis:** wycena rozminela sie o -47.7% przy poprawnym wykonaniu i przyjetej rekomendacji
  - **blad_modelu:** 1
  - **blad_wykonania:** 0
...
- **kalibracja**
  - **poprawki**
    ...
    - **kierunek:** w dol
    - **sugerowana_zmiana_pct:** -9.53
    - **podstawa:** roznica miedzy strata prognozowana a rzeczywista
    - **parametr:** szacunek_opoznienia
    - **kierunek:** w dol
    - **sugerowana_zmiana_pct:** -18.44
    - **podstawa:** prognoza 180 min wobec rzeczywistych 14 min
  - **tlumienie:** 0.20
