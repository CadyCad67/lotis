...
**Status:** ok · **run:** `20260906T190330` · **snapshot:** `sha256:f3c290f4e6930407` · **7.09 ms**

Wyceniono 7 opcji. Kategoria EU261: A (1075.00 PLN na pasazera), prog opieki 120 min, p(odszkodowanie) = 1.0. Najtansza `SWAP-SP-LIO` (34929.16 PLN), najdrozsza `REBOOK-OAL` (152636.24 PLN).
...
| `kurs_eur_pln` | 4.30 | - |
| `koszt_najtanszej` | 34929.16 PLN | PLN |
