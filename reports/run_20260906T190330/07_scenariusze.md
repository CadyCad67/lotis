...
**Status:** ok · **run:** `20260906T190330` · **snapshot:** `sha256:f3c290f4e6930407` · **16.64 ms**

Wygenerowano 7 opcji dla rejsu LO3981 (82 pasazerow, opoznienie 180 min). Odrzucono 2 rodzajow przed wycena.
...
- **opcje**
  ...
  - **SWAP-SP-LDH**
    ...
    - **opoznienia**
      ...
      - **LO3965-2026-08-21:** 180
    - **kasowane:** -
    - **uwagi**
      - zmiana pojemnosci -6 miejsc
      - rejs LO3965 przejmuje opoznienie 180 min
  ...
  - **SWAP-SP-LIO**
    ...
    - **opoznienia**
      - **LO3981-2026-08-21:** 36
      - **LO265-2026-08-21:** 180
    - **kasowane:** -
    - **uwagi**
      - zmiana pojemnosci +0 miejsc
      - rejs LO265 przejmuje opoznienie 180 min
      - rejs otrzymujacy maszyne nie zarabia -- unika straty
  - **SWAP-SP-LIQ**
    - **tryb:** RESTRUCTURING
    - **generator:** SZ.SWAP
    ...
    - **opoznienia**
      - **LO3981-2026-08-21:** 36
      - **LO655-2026-08-21:** 180
    - **kasowane:** -
    - **uwagi**
      - zmiana pojemnosci +0 miejsc
      - rejs LO655 przejmuje opoznienie 180 min
      - rejs otrzymujacy maszyne nie zarabia -- unika straty
  - **REBOOK-OAL**
    - **tryb:** RESTRUCTURING
