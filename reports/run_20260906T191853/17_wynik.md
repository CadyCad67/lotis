...
**Status:** ok · **run:** `20260906T191853` · **snapshot:** `sha256:f3c290f4e6930407` · **0.13 ms**

Rejs LO6: prognoza 1497475.90 PLN, rzeczywistosc 1497475.90 PLN, blad +0.0%. Klasyfikacja: ZGODNY. Wynik miesci sie w widelkach.
...
| `strata_prognozowana` | 1497475.90 PLN | PLN |
| `strata_rzeczywista` | 1497475.90 PLN | PLN |
| `blad` | 0.00 PLN | PLN |
