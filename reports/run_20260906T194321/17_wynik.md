...
**Status:** ok · **run:** `20260906T194321` · **snapshot:** `sha256:6c790f69f87c3591` · **0.08 ms**

Rejs LO82: prognoza 1213890.06 PLN, rzeczywistosc 1213890.06 PLN, blad +0.0%. Klasyfikacja: ZGODNY. Wynik miesci sie w widelkach.

## Liczby

| pole | wartosc | jednostka |
| --- | --- | --- |
| `opcja_wykonana` | OVERNIGHT | - |
| `opoznienie_prognozowane` | 0 | min |
| `opoznienie_rzeczywiste` | 33 | min |
| `strata_prognozowana` | 1213890.06 PLN | PLN |
| `strata_rzeczywista` | 1213890.06 PLN | PLN |
| `blad` | 0.00 PLN | PLN |
