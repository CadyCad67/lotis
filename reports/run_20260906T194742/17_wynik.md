...
**Status:** ok · **run:** `20260906T194742` · **snapshot:** `sha256:6c790f69f87c3591` · **0.08 ms**

Rejs LO395: prognoza 135169.21 PLN, rzeczywistosc 135169.21 PLN, blad +0.0%. Klasyfikacja: ZGODNY. Wynik miesci sie w widelkach.
...
| `opoznienie_prognozowane` | 720 | min |
| `opoznienie_rzeczywiste` | 24 | min |
| `strata_prognozowana` | 135169.21 PLN | PLN |
| `strata_rzeczywista` | 135169.21 PLN | PLN |
| `blad` | 0.00 PLN | PLN |
