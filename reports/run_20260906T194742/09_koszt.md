...
**Status:** ok · **run:** `20260906T194742` · **snapshot:** `sha256:6c790f69f87c3591` · **7.59 ms**

Wyceniono 9 opcji. Kategoria EU261: A (1075.00 PLN na pasazera), prog opieki 120 min, p(odszkodowanie) = 1.0. Najtansza `CANCEL` (112948.96 PLN), najdrozsza `HOLD` (250735.76 PLN).
...
| `kurs_eur_pln` | 4.30 | - |
| `koszt_najtanszej` | 112948.96 PLN | PLN |
| `koszt_najdrozszej` | 250735.76 PLN | PLN |
