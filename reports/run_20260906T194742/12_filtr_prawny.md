...
**Status:** degraded · **run:** `20260906T194742` · **snapshot:** `sha256:6c790f69f87c3591` · **0.51 ms**
...
- `HOLD` odrzucona -- Art. 9 EU261: oczekiwanie 720 min bez zapewnionego noclegu (prog opieki 120 min)
...
- **werdykty**
  - **HOLD**
    ...
    - **ostrzezenia**
      - opoznienie 720 min przekracza prog 300 min -- pasazer moze zrezygnowac i zadac zwrotu (Art. 8 ust. 1 lit. a)
  - **SWAP-SP-LIC**
    - **dopuszczalna:** 1
    - **zlamane_reguly:** -
    - **ostrzezenia:** -
