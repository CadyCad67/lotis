...
**Status:** ok · **run:** `20260905T181119` · **snapshot:** `sha256:44a9b3ee12dd2f25` · **32.22 ms**

Wygenerowano 6 opcji dla rejsu LO3850 (55 pasazerow, opoznienie 240 min). Odrzucono 1 rodzajow przed wycena.
...
- **opcje**
  ...
  - **REBOOK-OWN**
    ...
    - **uwagi**
      ...
      - czekanie 190 min liczy sie do progu opieki z Art. 9
  - **REBOOK-OAL**
    - **tryb:** RESTRUCTURING
    ...
    - **uwagi**
      ...
      - oczekiwanie 445 min z CF.onward.next_bank_min (6 rejsow dziennie na tej relacji) + MCT partnera
