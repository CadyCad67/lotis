...
**Status:** degraded · **run:** `20260906T190136` · **snapshot:** `sha256:f3c290f4e6930407` · **0.35 ms**

Ranking wstepny 6 opcji, priorytet 100. Najmniejsza strata: `HOLD` (144161.34 PLN), najwieksza: `OVERNIGHT` (113941.06 PLN).
...
| `strata_najlepszej` | 144161.34 PLN | PLN |
| `strata_najgorszej` | 113941.06 PLN | PLN |
| `rozpietosc_rankingu` | -30220.28 PLN | PLN |
...
- przy priorytecie 100 ranking wskazuje `HOLD`, a najtansza jest `REBOOK-OWN` (87716.13 PLN)
