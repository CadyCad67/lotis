...
**Status:** ok · **run:** `20260906T175204` · **snapshot:** `sha256:91cb2a4af61a3714` · **10.22 ms**

Cztery bramki na rejsie LO6 przy opoznieniu 120 min. Odpadly: zaloga, miejsca.
...
| `nowy_std` | 2026-08-22T14:10:00+00:00 | - |
| `nowy_sta` | 2026-08-22T23:40:00+00:00 | - |

## Co ten node ustalil

- bramka zaloga: 11 osob przekracza FDP przy opoznieniu 120 min (najgorszy zapas -605 min) -- opcje od niej zalezne odpadaja
...
- **bramki**
  ...
  - **zaloga**
    - **przeszla:** 0
    - **powod:** 11 osob przekracza FDP przy opoznieniu 120 min (najgorszy zapas -605 min)
    - **przekroczen:** 11
    - **lista**
      - **SP-LRG-CAP0**
        - **rola:** CAPTAIN
