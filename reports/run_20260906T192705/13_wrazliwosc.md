...
**Status:** degraded · **run:** `20260906T192705` · **snapshot:** `sha256:f3c290f4e6930407` · **0.46 ms**
...
- **ranking_koncowy**
  ...
  - **SWAP-SP-LIQ**
    ...
    - **oszczednosc**
      ...
      - **currency:** PLN
      - **major:** -994.63
    - **wskaznik:** 1 740 860.84
    - **uwaga_polityki:** propagacja 42 min (waga rotacji 1.0); szerokie widelki; priorytet 50, indeks pasazerski 0.60
  - **OVERNIGHT**
    - **pozycja:** 3
    - **strata**
      - **minor:** 15 732 196
    ...
    - **oszczednosc**
      ...
      - **currency:** PLN
      - **major:** -143163.50
    - **wskaznik:** 32 396 899.15
    - **uwaga_polityki:** szerokie widelki; priorytet 50, indeks pasazerski 18.00
  - **REBOOK-OAL**
    - **pozycja:** 4
    - **strata**
      - **minor:** 15 925 824
    ...
    - **oszczednosc**
      ...
      - **currency:** PLN
      - **major:** -145099.78
    - **wskaznik:** 32 795 632.23
    - **uwaga_polityki:** szerokie widelki; priorytet 50, indeks pasazerski 13.42
  - **CANCEL**
    - **pozycja:** 5
    - **strata**
      - **minor:** 17 008 109
    ...
    - **oszczednosc**
      ...
      - **currency:** PLN
      - **major:** -155922.63
    - **wskaznik:** 35 024 353.36
    - **uwaga_polityki:** szerokie widelki; priorytet 50, indeks pasazerski 24.00
- **test_wrazliwosci**
  - **krok_min:** 30
  - **lider:** SWAP-SP-LIO
  - **ranking**
