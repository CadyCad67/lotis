...
**Status:** degraded · **run:** `20260906T193212` · **snapshot:** `sha256:6c790f69f87c3591` · **1.61 ms**

Z 9 opcji przez filtr przeszlo 8. Odrzucono: HOLD.
...
- `HOLD` odrzucona -- Art. 8 EU261: 8 pasazerow zdjetych bez zapewnienia przewozu ani zwrotu
- `HOLD` odrzucona -- Art. 4 EU261: 8 pasazerow zdjetych wbrew woli bez uprzedniego wezwania ochotnikow
...
- `SPLIT`: opoznienie 625 min przekracza prog 300 min -- pasazer moze zrezygnowac i zadac zwrotu (Art. 8 ust. 1 lit. a)
