...
**Status:** ok · **run:** `20260906T193212` · **snapshot:** `sha256:6c790f69f87c3591` · **0.09 ms**

Rejs LO6: prognoza 38201.20 PLN, rzeczywistosc 38201.20 PLN, blad +0.0%. Klasyfikacja: ZGODNY. Wynik miesci sie w widelkach.
...
| `strata_prognozowana` | 38201.20 PLN | PLN |
| `strata_rzeczywista` | 38201.20 PLN | PLN |
| `blad` | 0.00 PLN | PLN |
