...
**Status:** ok · **run:** `20260906T193212` · **snapshot:** `sha256:6c790f69f87c3591` · **46.73 ms**

Wygenerowano 9 opcji dla rejsu LO6 (272 pasazerow, opoznienie 0 min). Odrzucono 0 rodzajow przed wycena.
...
- **opcje**
  ...
  - **SWAP-SP-LSE**
    ...
    - **uwagi**
      - zmiana pojemnosci +0 miejsc
      - rejs LO99 przejmuje opoznienie 0 min
      - rejs otrzymujacy maszyne nie zarabia -- unika straty
  - **REBOOK-OWN**
    - **tryb:** RESTRUCTURING
