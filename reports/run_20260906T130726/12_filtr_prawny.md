...
**Status:** degraded · **run:** `20260906T130726` · **snapshot:** `sha256:44a9b3ee12dd2f25` · **0.37 ms**

Z 9 opcji przez filtr przeszlo 9. Zadna nie odpadla.

## Liczby

| pole | wartosc | jednostka |
| --- | --- | --- |
| `opcji_na_wejsciu` | 9 | szt |
...
- **werdykty**
  ...
  - **REBOOK-OWN**
    ...
    - **zlamane_reguly:** -
    - **ostrzezenia**
      - opoznienie 550 min przekracza prog 300 min -- pasazer moze zrezygnowac i zadac zwrotu (Art. 8 ust. 1 lit. a)
  - **REBOOK-OAL**
    - **dopuszczalna:** 1
    - **zlamane_reguly:** -
    - **ostrzezenia**
...
- `REBOOK-OWN`: opoznienie 550 min przekracza prog 300 min -- pasazer moze zrezygnowac i zadac zwrotu (Art. 8 ust. 1 lit. a)
...
- `CANCEL`: opoznienie 550 min przekracza prog 300 min -- pasazer moze zrezygnowac i zadac zwrotu (Art. 8 ust. 1 lit. a)
- `SPLIT`: opoznienie 550 min przekracza prog 300 min -- pasazer moze zrezygnowac i zadac zwrotu (Art. 8 ust. 1 lit. a)
