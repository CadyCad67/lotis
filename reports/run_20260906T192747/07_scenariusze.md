...
**Status:** ok · **run:** `20260906T192747` · **snapshot:** `sha256:f3c290f4e6930407` · **46.64 ms**

Wygenerowano 10 opcji dla rejsu LO3931 (82 pasazerow, opoznienie 20 min). Odrzucono 0 rodzajow przed wycena.
...
- **opcje**
  ...
  - **REBOOK-SPILL**
    ...
    - **kasowane:** -
    - **uwagi**
      - Art. 4 ust. 1: najpierw ochotnicy, dopiero potem odmowa wbrew woli
      - czekanie 290 min liczy sie do progu opieki z Art. 9
  - **SWAP-SP-LDH**
    - **tryb:** RESTRUCTURING
    - **generator:** SZ.SWAP
    - **rejsy**
  ...
  - **SWAP-SP-LIC**
    ...
    - **opoznienia**
      - **LO3931-2026-08-21:** 36
      - **LO3853-2026-08-21:** 20
    - **kasowane:** -
    - **uwagi**
      - zmiana pojemnosci +0 miejsc
      - rejs LO3853 przejmuje opoznienie 20 min
      - rejs otrzymujacy maszyne nie zarabia -- unika straty
  - **SWAP-SP-LIO**
    - **tryb:** RESTRUCTURING
    - **generator:** SZ.SWAP
