...
**Status:** ok · **run:** `pelny` · **snapshot:** `sha256:f3c290f4e6930407` · **4.12 ms**
...
| `odcisk_wpisu` | sha256:71a3a8f50272a0a83cfc4d9a | - |
...
- **wpis**
  ...
  - **czas_runu:** 2026-09-05T17:17:09.375784+00:00
  - **zaklocenie**
  ...
  - **budzet**
    ...
    - **per_node_ms**
      ...
      - **15b:** 0.10
  - **degradacja:** FULL
  - **odcisk:** sha256:71a3a8f50272a0a83cfc4d9a
