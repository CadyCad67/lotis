...
**Status:** degraded · **run:** `20260906T192708` · **snapshot:** `sha256:f3c290f4e6930407` · **0.32 ms**
...
- **ranking_koncowy**
  ...
  - **SWAP-SP-LIQ**
    ...
    - **oszczednosc**
      ...
      - **currency:** PLN
      - **major:** -994.63
    - **wskaznik:** 1 575 439.68
    - **uwaga_polityki:** propagacja 42 min (waga rotacji 1.0); szerokie widelki
  - **OVERNIGHT**
    - **pozycja:** 3
    - **strata**
      - **minor:** 15 732 196
