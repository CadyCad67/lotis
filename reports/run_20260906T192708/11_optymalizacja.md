...
**Status:** degraded · **run:** `20260906T192708` · **snapshot:** `sha256:f3c290f4e6930407` · **0.44 ms**

Ranking wstepny 7 opcji, priorytet 0. Najmniejsza strata: `HOLD` (11833.94 PLN), najwieksza: `CANCEL` (170081.09 PLN).
...
| `strata_najlepszej` | 11833.94 PLN | PLN |
| `strata_najgorszej` | 170081.09 PLN | PLN |
| `rozpietosc_rankingu` | 158247.15 PLN | PLN |
