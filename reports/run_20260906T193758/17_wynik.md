...
**Status:** ok · **run:** `20260906T193758` · **snapshot:** `sha256:6c790f69f87c3591` · **0.09 ms**

Rejs LO6: prognoza 43034.90 PLN, rzeczywistosc 54195.54 PLN, blad +25.9%. Klasyfikacja: BLAD_MODELU. Wynik miesci sie w widelkach.
...
| `strata_prognozowana` | 43034.90 PLN | PLN |
| `strata_rzeczywista` | 54195.54 PLN | PLN |
| `blad` | 11160.64 PLN | PLN |
| `blad_procentowo` | 25.93 | % |
| `w_widelkach` | 1 | - |
| `rodzaj_bledu` | BLAD_MODELU | - |

## Co ten node ustalil

- wycena rozminela sie o +25.9% przy poprawnym wykonaniu i przyjetej rekomendacji
...
- **klasyfikacja**
  - **rodzaj:** BLAD_MODELU
  - **opis:** wycena rozminela sie o +25.9% przy poprawnym wykonaniu i przyjetej rekomendacji
  - **blad_modelu:** 1
  - **blad_wykonania:** 0
