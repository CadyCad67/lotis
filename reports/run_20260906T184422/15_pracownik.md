...
**Status:** ok · **run:** `20260906T184422` · **snapshot:** `sha256:d7806668b46167a3` · **0.05 ms**

OCC-DUTY: ACCEPT dla `HOLD` (0.00 PLN). Wymagana rola: Dyzurny OCC.
...
| `kwota_do_autoryzacji` | 0.00 PLN | PLN |
...
- kwota 0.00 PLN miesci sie w pasmie roli `Dyzurny OCC`
