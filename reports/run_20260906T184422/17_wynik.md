...
**Status:** ok · **run:** `20260906T184422` · **snapshot:** `sha256:d7806668b46167a3` · **0.09 ms**

Rejs LO35: prognoza 0.00 PLN, rzeczywistosc 0.00 PLN, blad +0.0%. Klasyfikacja: ZGODNY. Wynik miesci sie w widelkach.
...
| `opoznienie_rzeczywiste` | 53 | min |
| `strata_prognozowana` | 0.00 PLN | PLN |
| `strata_rzeczywista` | 0.00 PLN | PLN |
| `blad` | 0.00 PLN | PLN |
