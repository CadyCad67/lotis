...
**Status:** degraded · **run:** `20260906T130705` · **snapshot:** `sha256:44a9b3ee12dd2f25` · **0.09 ms**

Rejs LO417: prognoza 60783.55 PLN, rzeczywistosc 33404.03 PLN, blad -45.0%. Klasyfikacja: BLAD_MODELU. Wynik POZA widelkami prognozy.
...
- wycena rozminela sie o -45.0% przy poprawnym wykonaniu i przyjetej rekomendacji
...
- **klasyfikacja**
  - **rodzaj:** BLAD_MODELU
  - **opis:** wycena rozminela sie o -45.0% przy poprawnym wykonaniu i przyjetej rekomendacji
  - **blad_modelu:** 1
  - **blad_wykonania:** 0
...
- **kalibracja**
  - **poprawki**
    ...
    - **kierunek:** w dol
    - **sugerowana_zmiana_pct:** -9.01
    - **podstawa:** roznica miedzy strata prognozowana a rzeczywista
    - **parametr:** szacunek_opoznienia
    - **kierunek:** w dol
    - **sugerowana_zmiana_pct:** -17.78
    - **podstawa:** prognoza 180 min wobec rzeczywistych 20 min
  - **tlumienie:** 0.20
