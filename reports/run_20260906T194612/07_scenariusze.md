...
**Status:** ok · **run:** `20260906T194612` · **snapshot:** `sha256:6c790f69f87c3591` · **47.03 ms**

Wygenerowano 10 opcji dla rejsu LO395 (79 pasazerow, opoznienie 60 min). Odrzucono 0 rodzajow przed wycena.
...
- **opcje**
  ...
  - **SWAP-SP-LIC**
    ...
    - **uwagi**
      ...
      - rejs LO535 przejmuje opoznienie 60 min
  ...
  - **SWAP-SP-LID**
    ...
    - **uwagi**
      - zmiana pojemnosci -24 miejsc
      - rejs LO653 przejmuje opoznienie 60 min
      - rejs otrzymujacy maszyne nie zarabia -- unika straty
  - **SWAP-SP-LII**
    - **tryb:** RESTRUCTURING
    - **generator:** SZ.SWAP
    ...
    - **opoznienia**
      - **LO395-2026-08-24:** 41
      - **LO3809-2026-08-24:** 60
    - **kasowane:** -
    - **uwagi**
      - zmiana pojemnosci -24 miejsc
      - rejs LO3809 przejmuje opoznienie 60 min
      - rejs otrzymujacy maszyne nie zarabia -- unika straty
  - **REBOOK-OWN**
    - **tryb:** RESTRUCTURING
