...
**Status:** ok · **run:** `20260906T190130` · **snapshot:** `sha256:f3c290f4e6930407` · **4.86 ms**

Wyceniono 6 opcji. Kategoria EU261: A (1075.00 PLN na pasazera), prog opieki 120 min, p(odszkodowanie) = 1.0. Najtansza `HOLD` (10750.00 PLN), najdrozsza `OVERNIGHT` (107319.06 PLN).
...
| `kurs_eur_pln` | 4.30 | - |
| `koszt_najtanszej` | 10750.00 PLN | PLN |
