...
**Status:** degraded · **run:** `20260906T190130` · **snapshot:** `sha256:f3c290f4e6930407` · **0.33 ms**

Ranking koncowy 5 dopuszczalnych opcji. Rekomendacja: `REBOOK-OWN` (87716.13 PLN), oszczednosc wobec opcji domyslnej `REBOOK-OWN`: 0.00 PLN.
...
| `widelki_min` | 79492.75 PLN | PLN |
| `widelki_max` | 105990.32 PLN | PLN |
| `opcja_domyslna` | REBOOK-OWN | - |
| `strata_opcji_domyslnej` | 87716.13 PLN | PLN |
...
- opcja domyslna to `REBOOK-OWN` -- oszczednosc liczy sie wzgledem niej, a nie wzgledem nicnierobienia
