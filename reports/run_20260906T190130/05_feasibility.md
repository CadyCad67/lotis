...
**Status:** ok · **run:** `20260906T190130` · **snapshot:** `sha256:f3c290f4e6930407` · **9.59 ms**

Cztery bramki na rejsie LO3996 przy opoznieniu 0 min. Odpadly: samolot, zaloga.
...
| `nowy_std` | 2026-08-21T05:35:00+00:00 | - |
| `nowy_sta` | 2026-08-21T06:25:00+00:00 | - |

## Co ten node ustalil

- bramka samolot: port BZG nie jest baza SWAP (baza dopuszcza WAW) -- opcje od niej zalezne odpadaja
- bramka zaloga: 4 osob przekracza FDP przy opoznieniu 0 min (najgorszy zapas -610 min) -- opcje od niej zalezne odpadaja
...
- **bramki**
  ...
  - **zaloga**
    - **przeszla:** 0
    - **powod:** 4 osob przekracza FDP przy opoznieniu 0 min (najgorszy zapas -610 min)
    - **przekroczen:** 4
    - **lista**
      - **SP-LDI-CAP0**
        - **rola:** CAPTAIN
