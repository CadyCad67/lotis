...
**Status:** ok · **run:** `20260906T190325` · **snapshot:** `sha256:f3c290f4e6930407` · **15.52 ms**

Wygenerowano 7 opcji dla rejsu LO3981 (82 pasazerow, opoznienie 0 min). Odrzucono 2 rodzajow przed wycena.
...
- **opcje**
  ...
  - **SWAP-SP-LDH**
    ...
    - **uwagi**
      ...
      - rejs LO3965 przejmuje opoznienie 0 min
  ...
  - **SWAP-SP-LIO**
    ...
    - **uwagi**
      ...
      - rejs LO265 przejmuje opoznienie 0 min
      - rejs otrzymujacy maszyne nie zarabia -- unika straty
  - **SWAP-SP-LIQ**
    - **tryb:** RESTRUCTURING
    - **generator:** SZ.SWAP
    ...
    - **uwagi**
      - zmiana pojemnosci +0 miejsc
      - rejs LO655 przejmuje opoznienie 0 min
      - rejs otrzymujacy maszyne nie zarabia -- unika straty
  - **REBOOK-OAL**
    - **tryb:** RESTRUCTURING
