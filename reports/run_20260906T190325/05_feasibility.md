...
**Status:** ok · **run:** `20260906T190325` · **snapshot:** `sha256:f3c290f4e6930407` · **9.93 ms**

Cztery bramki na rejsie LO3981 przy opoznieniu 0 min. Odpadly: zaloga, miejsca.
...
| `nowy_sta` | 2026-08-21T08:05:00+00:00 | - |

## Co ten node ustalil

- bramka zaloga: 4 osob przekracza FDP przy opoznieniu 0 min (najgorszy zapas -365 min) -- opcje od niej zalezne odpadaja
...
- **bramki**
  ...
  - **zaloga**
    - **przeszla:** 0
    - **powod:** 4 osob przekracza FDP przy opoznieniu 0 min (najgorszy zapas -365 min)
    - **przekroczen:** 4
    - **lista**
      - **SP-LIC-CAP0**
        - **rola:** CAPTAIN
