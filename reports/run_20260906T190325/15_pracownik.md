...
**Status:** ok · **run:** `20260906T190325` · **snapshot:** `sha256:f3c290f4e6930407` · **0.05 ms**

OCC-DUTY: ACCEPT dla `SWAP-SP-LIO` (12035.06 PLN). Wymagana rola: Dyzurny OCC.
...
| `kwota_do_autoryzacji` | 13467.80 PLN | PLN |
...
- kwota 13467.80 PLN miesci sie w pasmie roli `Dyzurny OCC`
