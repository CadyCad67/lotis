...
**Status:** ok · **run:** `20260906T190325` · **snapshot:** `sha256:f3c290f4e6930407` · **10.78 ms**

Zdarzenie pasazerskie na rejsie LO3981 WAW-IEG, nadsprzedaz 40 rezerwacji. Decyzja do 07:05 UTC (45 min).
...
| `nadsprzedaz` | 40 | rezerwacji |
| `ponad_pojemnosc` | 40 | osob |
| `kod_opoznienia` | 14 | - |
| `klasa_kodu` | c | - |
...
- nadsprzedaz: 40 pasazerow nie miesci sie w kabinie (122 na 82 miejsc)
