...
**Status:** ok · **run:** `20260906T131947` · **snapshot:** `sha256:3b1d18402faf79f0` · **18.87 ms**

Wygenerowano 7 opcji dla rejsu LO21 (281 pasazerow, opoznienie 30 min). Odrzucono 2 rodzajow przed wycena.
...
| `pasazerow_dotknietych` | 281 | osob |
...
- **opcje**
  ...
  - **SWAP-SP-LRD**
    ...
    - **uwagi**
      ...
      - rejs LO71 przejmuje opoznienie 30 min
      - rejs otrzymujacy maszyne nie zarabia -- unika straty
      - downgauge: 29 pasazerow schodzi
  - **SWAP-SP-LRG**
    - **tryb:** RESTRUCTURING
    - **generator:** SZ.SWAP
    - **rejsy**
  ...
  - **SWAP-SP-LSC**
    ...
    - **uwagi**
      ...
      - rejs LO6 przejmuje opoznienie 30 min
      - rejs otrzymujacy maszyne nie zarabia -- unika straty
  - **REBOOK-OAL**
    - **tryb:** RESTRUCTURING
