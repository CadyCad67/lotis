...
def build_pipeline(
    *,
    ...
    return [
        ...
        WalidacjaNode(),
        BaselineNode(),
        ZaklocenieNode(flight_id=flight_id, delay_min=delay_min,
                       delay_code=delay_code, overbooking=overbooking),
        FeasibilityNode(),
        ZasobyNode(),
        ScenariuszeNode(),
        RevenueNode(),
        KosztNode(),
        SiecNode(),
        OptymalizacjaNode(priority=priority),
        FiltrPrawnyNode(),
        WrazliwoscNode(priority=priority, preset=preset),
        AiReasoningNode(),
